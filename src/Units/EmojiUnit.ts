...
/**
 * Represents a unit for creating emojis.
 *
 * @template TSettings
 ...
 */
export class EmojiUnit<TSettings extends IWoltLabGeneratorSettings, TOptions extends GeneratorOptions> extends WoltLabUnit<TSettings, TOptions>
{
    /**
     * @inheritdoc
     */
    ...
    {
        return this.Generator.templatePath("components", "Emojis.ts.ejs");
    }
}
