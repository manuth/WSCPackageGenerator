...
/**
 * Represents a unit for creating group-options.
 *
 * @template TSettings
 ...
 */
export class GroupOptionsUnit<TSettings extends IWoltLabGeneratorSettings, TOptions extends GeneratorOptions> extends WoltLabUnit<TSettings, TOptions>
{
    /**
     * @inheritdoc
     */
    ...
    {
        return WoltLabUnitName.GroupOptions;
    }
    ...
    {
        return this.Generator.templatePath("components", "GroupOptions.ts.ejs");
    }
}
