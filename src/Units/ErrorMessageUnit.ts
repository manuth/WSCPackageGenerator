...
/**
 * Represents a unit for creating error-messages.
 */
export class ErrorMessageUnit<TSettings extends IWoltLabGeneratorSettings, TOptions extends GeneratorOptions> extends WoltLabUnit<TSettings, TOptions>
{
    /**
     * @inheritdoc
     */
    ...
    {
        return WoltLabUnitName.ErrorMessages;
    }
    ...
    {
        return this.Generator.templatePath("components", "ErrorMessages.ts.ejs");
    }
}
